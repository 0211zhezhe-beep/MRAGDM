...
Schematic overview of MRAGDM, including genetic feature processing, heterogeneous network construction from PPI and ncRNA interactions, relation-specific graph diffusion with restart and edge attention, coupling attention fusion, and final prediction of cancer versus non-cancer genes.
